...
namespace OrderService.Infrastructure.Migrations.SagaDb
{
    ...
    [Migration("20251024155419_InitPostgresExtension")]
    partial class InitPostgresExtension
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderService.Application.Sagas.OrderState", b =>
                {
                    ...
                    b.HasIndex("CurrentState")
                        .HasDatabaseName("IX_OrderState_CurrentState");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("IX_OrderState_OrderId");
